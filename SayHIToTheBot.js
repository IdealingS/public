...
>> 위에 1, 2번은 무시하세요. 업데이트로 파일은 자동 생성 및 형식 됩니다.
      ...
      3. 몇가지 기초 지식이 필요합니다.
         ...
         아래 110번째 줄을 보시면 "String Here"가 보이실텐데, 이곳에 응답 데이터를 작성하시면 됩니다.
...
function response(room,msg,sender,isGroupChat,replier) {
   ...
   var room1 = 0;
   var save = "/storage/emulated/0/인사데이터/";
       sender = sender.replace(/[^A-Za-z_-]/g,"");
   var result = "전체 인사데이터 입니다.\n\n" + "카이젠님 방 인사인원 내용 입니다.\n" +  FileStream.read(save + "Kaizen.txt") + "\n\n쥬이스님 방 인사인원 내용 입니다.\n" + FileStream.read(save + "nJuice.txt") +"\n\n컬투님 방 인사인원 내용 입니다.\n" + FileStream.read(save + "Cultwo.txt") + "\n\n턴업님 방 인사인원 내용 입니다.\n" + FileStream.read(save + "TurnUp.txt");
       result = result.replace(/'/g,"").replace(/ = true;/g,"");
